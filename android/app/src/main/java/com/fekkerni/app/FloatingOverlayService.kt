...
class FloatingOverlayService : Service() {
  ...
  private inner class OverlayView(context: Context) : View(context) {
    ...
    private fun drawGhost(canvas: Canvas, x: Float, y: Float, alpha: Float, gaze: Float, scale: Float = 1f, eyeOffsetY: Float = 0f) {
      ...
      ghostPath.cubicTo(x - ghostWidth * 0.54f, top + ghostHeight * 0.28f, x - ghostWidth * 0.5f, top + ghostHeight * 0.43f, left, y + ghostHeight * 0.16f)
      ...
      ghostPath.cubicTo(right, top + ghostHeight * 0.43f, x + ghostWidth * 0.54f, top + ghostHeight * 0.28f, x + ghostWidth * 0.27f, top + ghostHeight * 0.025f)
      ghostPath.cubicTo(x + ghostWidth * 0.13f, top - ghostHeight * 0.12f, x - ghostWidth * 0.13f, top - ghostHeight * 0.12f, x - ghostWidth * 0.27f, top + ghostHeight * 0.025f)
      ghostPath.close()
